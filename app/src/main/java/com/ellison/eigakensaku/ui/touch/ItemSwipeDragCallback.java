...
public class ItemSwipeDragCallback extends ItemTouchHelper.Callback implements ISwipeGestureListener.ISwipeMenuCallback {
    private static final String TAG = ItemSwipeDragCallback.class.getSimpleName();
    ...
    public float getSwipeThreshold(@NonNull RecyclerView.ViewHolder viewHolder) {
        return Constants.SWIPE_SHOW_MENU_THRESHOLD_FOR_STAR;
    }
...
//        }
    ...
    public boolean onMove(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ViewHolder target) {
        ...
        if (viewHolder instanceof ISwipeGestureListener) {
            Utils.logDebug(TAG, "onMoved() onDragOver() CALLBACK");
            ((ISwipeGestureListener) viewHolder).onDragOver(target.getAdapterPosition());
            return true;
        }
        return false;
    }
